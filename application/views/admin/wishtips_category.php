<div class="boxed">
				...
				<div id="page-content">
					...
					<div class="panel">
						...
						<div class="pull-left col-md-6">
							<h3 class="panel-title">Wishtips Category Listings</h3>
						</div>
							<div class="pull-right col-md-6" style="text-align: right; margin-top: 10px;">
								<button data-target="#category-modal" data-toggle="modal" class="category_modal btn btn-success">Add New Category</button>
							</div>
						</div>
						<div class="panel-body">
							<table id="wishtips_category" class="table table-striped table-bordered" cellspacing="0" width="100%">
								<thead>
									<tr>
										<th>Category</th>
          ...
          <?php $sidebar_data = array("trip_count" => $today_count);
                $sidebar_data["wishtips_category"] = $wishtips_category;
		...
		<div class="modal fade" id="category-modal" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<!--Modal body-->
					<form action="<?php echo base_url('admin/save_wishtips_category') ?>" method = "post" id="add_category" class="form-horizontal">
		...
		<div class="modal fade" id="edit-category-modal" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<!--Modal body-->
					<form action="<?php echo base_url('admin/edit_wishtips_category') ?>" method = "post" id="edit_category" class="form-horizontal">
						...
						<div class="modal-body">
							<div class="row">
								  <div class="col-md-12">
									...
									<input type="hidden" name="wishtips_cat_id" id="wishtips_cat_id" value="">
								  </div>
								</div>
						</div>
  ...
  <script src="//cdn.datatables.net/1.10.2/js/jquery.dataTables.min.js"></script>
    ...
    <script>
	    $(document).ready(function(){
	    	var oTable= $('#wishtips_category').DataTable({
				"aoColumns": [
					{ "iDataSort": 1 },
					{ "bSortable": false },
				],
				...
				"responsive": true,
				"iDisplayLength":10,
				"ajax": "<?php echo base_url('admin/wishtips_category'); ?>",
			});
	    	...
	    	$(document).on("submit","#add_category,#edit_category",function(e){ 
				e.preventDefault();
				var elem = $(this);
				...
				$.ajax({
					...
					success: function (data) {
						if(!data.error){
                            ...
                            $('#wishtips_category').DataTable().ajax.reload();
							setTimeout(function(){
			...
			$(document).on("click",".delete_wishtip_category",function(e){ 
				e.preventDefault();
		        var elem = $(this);
		        ...
		        $.ajax({
		            ...
		            success: function (data) {
		                if (!data.error) {
		                    ...
		                    var _model = $("#edit-category-modal");
		                    _model.find("#category").val(details.category_name);
		                    _model.find("#wishtips_cat_id").val(details.wishtips_cat_id);
		                    _model.modal("show");
		                } else {
		                    alert(data.message);
		                }
