<div class="boxed">
            <?php
                if(!empty($form_error) || !empty($file_error) || !empty($success) || isset($trip->favorite_trip_id)){
                    $error= TRUE;
                }else{
                    $error= FALSE;
                }
				...
				<div id="page-content">
                                    <div class="tab-base">
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="<?php echo ($error)?'':'active'; ?>">
                                                <a data-toggle="tab" href="#demo-lft-tab-1" aria-expanded="false">Favorite Trip Listings</a>
                                            </li>
                                            <li class="<?php echo ($error)?'active':''; ?>">
                                                <a class="reset_form" data-toggle="tab" href="#demo-lft-tab-2" aria-expanded="false">Add Favorite Trip</a>
                                            </li>
                                        </ul>
					...
					<div class="panel">
						<div class="panel-heading">
                                                        <div class="pull-left col-md-6">
                                                            <h3 class="panel-title">Favorite Trip Listings</h3>
                                                        </div>
						...
						<div class="panel-body">
								...
								<thead>
									<tr>
										<th>Title</th>
										<th class="min-tablet">Picrure</th>
										<th class="min-desktop">Check In</th>
										<th class="min-desktop">Check Out</th>
								...
								<tbody id = "sortable">
								    <?php if(!empty($trips)): 
                                                                        ...
                                                                        {
                                                                    ?>  
                                                                    <tr id="<?php echo $val['favorite_trip_id']; ?>##<?php echo $i; ?>">
                                                                        <td><?php echo (strlen($val['title']) > 20) ? substr($val['title'],0,20).'...' : $val['title']; ?></td>
                                                                        <td><img src="<?php echo base_url("uploads/".$val['picture']); ?>" width="100" /></td>
                                                                        <td><?php echo date("d F, Y", strtotime($val['check_in'])); ?></td>
                                                                        <td><?php echo date("d F, Y", strtotime($val['check_out'])); ?></td>
                                                                        <td><?php echo $val['location']; ?></td>
                                                                        <td><?php echo $val['order']; ?></td>
                                                                        <td><a class="btn btn-info" href='<?php echo base_url("admin/edit_favorite_trip/".$val["favorite_trip_id"]); ?>' title="Edit Trip" >Edit</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-danger delete_favorite_trip" href='<?php echo base_url("admin/delete"); ?>' data-id="<?php echo $val['favorite_trip_id']; ?>" title="Delete">Delete</a></td>
                                                                    </tr>             
                                                                        <?php $i++; } ?>
                                                                    <?php endif; ?>
								</tbody>
					...
					<!-- End Striped Table -->
                                            ...
                                            <div id="demo-lft-tab-2" class="tab-pane fade <?php echo ($error     )?'active':''; ?> in">
                                                ...
                                                <?php endif; ?>
                                                <form action="<?php echo base_url("admin/favorite_trips") ?>" method = "post" id="favorite_trip" class="form-horizontal" enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group <?php echo (form_error('title'))?'has_error':'' ;?>">
                                                              <label class="col-md-4 control-label" for="title">Title</label>
                                                              <div class="col-md-6">
                                                                <input id="title" name="title" placeholder="Title" class="form-control input-md" type="text" value="<?php echo set_value('title') ? set_value('title') : (isset($trip->title) ? $trip->title : ''); ?>"required>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group <?php echo (form_error('check_in'))?'has_error':'' ;?>">
                                                              <label class="col-md-4 control-label" for="check_in">Check In</label>
                                                              <div class="col-md-6">
                                                                <input id="check_in" name="check_in" placeholder="Check In" class="form-control input-md" type="text" value="<?php echo set_value('check_in') ? set_value('check_in') : (isset($trip->check_in) ? date("m/d/Y", strtotime($trip->check_in)) : ''); ?>" required>
                                                                <?php echo form_error('check_in'); ?>
                                                                <span class="help-block"</span> </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group <?php echo (form_error('check_out'))?'has_error':'' ;?>">
                                                              <label class="col-md-4 control-label" for="name">Check Out</label>
                                                              <div class="col-md-6">
                                                                  <input id="check_out" name="check_out" placeholder="Check Out" class="form-control input-md" type="text" value="<?php echo set_value('check_out') ? set_value('check_out') : (isset($trip->check_out) ? date("m/d/Y", strtotime($trip->check_out)) : ''); ?>" required>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group <?php echo (form_error('userfile'))?'error':'' ;?>">
                                                              ...
                                                              <div class="col-md-6 ">       
                                                                  ...
                                                                  <span><?php echo isset($trip->picture) ? $trip->picture : ''; ?></span>
                                                                    <input id="userfile" name="userfile" type="file">
                                                                    <span class="help-block"><?php if(isset($file_error)): echo $file_error; endif; ?></span> </div>
                                                            </div>
                                                        </div>
                                                        <?php if(!empty($trip)): ?>
                                                        <input type="hidden" name="favorite_id" id="favorite_id" value="<?php echo isset($trip->favorite_trip_id) ? $trip->favorite_trip_id : ''; ?>"/>
                                                        <input type="hidden" name="picture" id="picture" value="<?php echo isset($trip->picture) ? $trip->picture : ''; ?>"/>
                                                        <?php endif; ?>
                                                        <div class="form-group text-center">
                                                            <button type="submit" class="btn btn-primary"> &nbsp; &nbsp;  Save Favorite Trip &nbsp; &nbsp; </button>
           ...
           <!--END CONTENT CONTAINER-->
			<?php $sidebar_data = array("trip_count" => $today_count);
                              $sidebar_data["favorite_trips"] = $favorite_trip;
  ...
  <script>
        $(document).ready(function(){
	    	$("#location").geocomplete();
                ...
                $(document).on("click",".delete_favorite_trip",function(e){ 
                        e.preventDefault();
                        var elem = $(this);
                ...
                $("#userfile").on('change', function () {
                 ...
                 $('#sortable').sortable({
                    ...
                    stop: function (event, ui) {
                        ...
                        var table = "favorite_trips"; 
                        var where = "favorite_trip_id";
                        $.ajax({
