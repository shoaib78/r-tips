...
<div class="boxed">
        ...
        <div id="page-content">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <table id="wishtips" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                        <tr>
                            <th class="min-desktop">User</th>
                            <th class="min-desktop">Feedback</th>
                            <th class="min-desktop">Reason</th>
                            <th class="min-desktop">Wishtip Description</th>
    ...
    $sidebar_data["wishtips_report"] = $wishtips_report;
...
<script>
    $(document).ready(function () {
        var oTable = $('#wishtips').DataTable({
            ...
            "responsive": true,
            "iDisplayLength":10,
            "ajax": "<?php base_url('admin/wishtips_report'); ?>"
        });
    });
</script>
</body>
