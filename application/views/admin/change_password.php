            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <form method="post" id="reset_password" action="<?php echo current_url() ?>">
                        <div class="form-group <?php echo (form_error('old_password'))?'has_error':'' ;?>">
                        ...
                        <div class="form-group <?php echo (form_error('new_password'))?'has_error':'' ;?>">
                        ...
                        <span class="help-block"></span>
                        <div class="form-group <?php echo (form_error('cpassword'))?'has_error':'' ;?>">
