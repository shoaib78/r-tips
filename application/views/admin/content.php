...
<div id="content-container">
  ...
  <div id="page-content">
            ...
            <div class="row">
              <div class="col-lg-9">
                ...
                <div class="row">
                  <div class="col-xs-5">
                    <div class="media">
                      <div class="media-left"> <span class="text-3x text-thin">43.7</span> </div>
                  ...
                  <div class="col-xs-7 text-sm">
                    <p> <span>Min Values</span> <span class="pad-lft text-semibold"> <span class="text-lg">27°</span> <span class="labellabel-success mar-lft"> <i class="fa fa-caret-down text-success"></i>
                      <smal>23%</smal>
                      </span> </span> </p>
                    <p> <span>Max Values</span> <span class="pad-lft text-semibold"> <span class="text-lg">69°</span> <span class="labellabel-danger mar-lft"> <i class="fa fa-caret-up text-danger"></i>
                      <smal>57%</smal>
                      </span> </span> </p>
                  </div>
                </div>
                ...
                <ul class="list-unstyled">
                  <li>
                    <div class="media pad-btm">
                      <div class="media-left"> <span class="text-2x text-thin">754.9</span> </div>
                      <div class="media-body">
                  ...
                  <li class="pad-btm">
                    ...
                    <div class="progress progress-xs">
                      <div class="progress-bar" style="width: 70%;"> <span class="sr-only">70% Complete</span> </div>
                    </div>
                  </li>
                  <li>
                    <div class="clearfix">
                    ...
                    <div class="progress progress-xs">
                      <div class="progress-bar progress-bar-info" style="width: 10%;"> <span class="sr-only">10% Complete</span> </div>
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <div class="col-sm-6 col-lg-6">
            ...
            <div class="panel panel-success panel-colorful">
              <div class="pad-all">
                ...
                <p class="mar-no"> <span class="pull-right text-bold">132Gb</span> Free Space </p>
                <p class="mar-no"> <span class="pull-right text-bold">1,45Gb</span> Used space </p>
              </div>
          ...
          <div class="col-sm-6 col-lg-6">
            ...
            <div class="panel panel-info panel-colorful">
              <div class="pad-all">
                ...
                <p class="mar-no"> <span class="pull-right text-bold">$764</span> Today </p>
                <p class="mar-no"> <span class="pull-right text-bold">$1,332</span> Last 7 Day </p>
              </div>
              <div class="pad-all text-center">
                <!--Placeholder-->
          ...
          <div class="col-sm-6 col-lg-6">
            ...
            <div class="panel panel-warning panel-colorful">
              <div class="pad-all">
                ...
                <p class="mar-no"> <span class="pull-right text-bold">34</span> Completed </p>
                <p class="mar-no"> <span class="pull-right text-bold">79</span> Total </p>
              </div>
              <div class="pad-all">
                <ul class="list-group list-unstyled">
                  <li class="mar-btm"> <span class="label label-warning pull-right">15%</span>
                    <p>Progress</p>
                    <div class="progress progress-md">
                      <div style="width: 15%;" class="progress-bar progress-bar-light"> <span class="sr-only">15%</span> </div>
                    </div>
                  </li>
                </ul>
                <!--Placeholder-->
    ...
    <div class="row">
      <div class="col-sm-6 col-lg-3">
        ...
        <div class="panel media pad-all">
          <div class="media-left"> <span class="icon-wrap icon-wrap-sm icon-circle bg-success"> <i class="fa fa-user fa-2x"></i> </span> </div>
          <div class="media-body">
      ...
      <div class="col-sm-6 col-lg-3">
        ...
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <div class="panel media pad-all">
          <div class="media-left"> <span class="icon-wrap icon-wrap-sm icon-circle bg-info"> <i class="fa fa-shopping-cart fa-2x"></i> </span> </div>
          <div class="media-body">
      ...
      <div class="col-sm-6 col-lg-3">
        ...
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <div class="panel media pad-all">
          <div class="media-left"> <span class="icon-wrap icon-wrap-sm icon-circle bg-warning"> <i class="fa fa-comment fa-2x"></i> </span> </div>
          <div class="media-body">
      ...
      <div class="col-sm-6 col-lg-3">
        ...
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <div class="panel media pad-all">
          <div class="media-left"> <span class="icon-wrap icon-wrap-sm icon-circle bg-danger"> <i class="fa fa-dollar fa-2x"></i> </span> </div>
          <div class="media-body">
            ...
            <ul class="list-unstyled mar-no clearfix">
              <li class="col-xs-4">
                <div class="text-uppercase par-btm">
                  ...
                  <small class="text-muted">Cloudy</small> </div>
              ...
              <li class="col-xs-4">
                <div class="text-uppercase par-btm">
                  ...
                  <small class="text-muted">Wind</small> </div>
              ...
              <li class="col-xs-4">
                <div class="text-uppercase par-btm">
                  ...
                  <small class="text-muted">Rain</small> </div>
        ...
        <div class="panel">
          <div class="pad-all">
            <div class="media mar-btm">
              <div class="media-left"> <img src="<?php echo base_url(); ?>assets/admin/img/av6.png" class="img-md img-circle" alt="Avatar"> </div>
              <div class="media-body">
          ...
          <div class="bord-top">
            <ul class="list-group bord-no">
              <li class="list-group-item list-item-sm">
                <div class="media-left"> <i class="fa fa-facebook-official fa-lg"></i> </div>
                <div class="media-body"> <a href="#" class="btn-link">Facebook</a> </div>
              </li>
              <li class="list-group-item list-item-sm">
                <div class="media-left"> <i class="fa fa-twitter fa-lg"></i> </div>
                <div class="media-body"> <a href="#" class="btn-link">@BRfull</a> <br>
                  Design my themes with <a href="#" class="btn-link">#Bootstrap</a> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. </div>
              </li>
              <li class="list-group-item list-item-sm">
                <div class="media-left"> <i class="fa fa-linkedin fa-lg"></i> </div>
                <div class="media-body"> <a href="#" class="btn-link">brendafull</a> </div>
              </li>
              <li class="list-group-item list-item-sm">
    ...
    <div class="panel">
      <div class="panel-heading">
        <div class="panel-control"> <a class="fa fa-question-circle fa-lg fa-fw unselectable add-tooltip" href="#" data-original-title="<h4 class='text-thin'>Information</h4><p style='width:150px'>This is an information bubble to help the user.</p>" data-html="true" title=""></a> </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 table-toolbar-right">
              ...
              <div class="btn-group">
                ...
                <div class="btn-group">
                  <button class="btn btn-default dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-cog"></i> <span class="caret"></span> </button>
