            ...
            <article>
                ...
                <div class="artic-tools">
                    ...
                    <ul class="list-inline">
                        ...
                        <li>
                            ...
                            <a id="tipLike_<?php echo $wishtip->wishtips_id ?>"

                               onclick="<?php echo ($wishtip->is_like) ? 'unlike_tip(this);' : 'like_tip(this);' ?>"

                               class="<?php echo ($wishtip->is_like) ? 'unlikeTip' : 'likeTip' ?> heart"

                               actType="like_tip" objType="<?php echo 'tip' ?>"

                               objectId="<?php echo $wishtip->wishtips_id ?>"

                               obj_parent_id="<?php echo $wishtip->owner_id ?>" data-toggle="tooltip" data-placement="top" title="Like this Tip"
                        ...
                        <li>
                            ...
                            <a id="tipPlaneLike_<?php echo $wishtip->wishtips_id ?>"

                               onclick="<?php echo ($wishtip->is_like_plane) ? 'unlike_tip(this);' : 'like_tip(this);' ?>"

                               class="<?php echo ($wishtip->is_like_plane) ? 'unlikeTipPlane' : 'likeTipPlane' ?> plane"

                               actType="like_tip_in_plane" objType="<?php echo 'tip' ?>"

                               objectId="<?php echo $wishtip->wishtips_id ?>"

                               obj_parent_id="<?php echo $wishtip->owner_id ?>" data-toggle="tooltip" data-placement="top" href="javascript:void(0)"
                        ...
                        <li>
                            ...
                            <a id="tipPlaneInLike_<?php echo $wishtip->wishtips_id ?>"

                               onclick="<?php echo ($wishtip->is_like_plane_in) ? 'unlike_tip(this);' : 'like_tip(this);' ?>"

                               class="<?php echo ($wishtip->is_like_plane_in) ? 'unlikeTipPlaneInside' : 'likeTipPlaneInside' ?> p-plane"

                               actType="like_tip_in_location" objType="<?php echo 'tip' ?>"
                        ...
                        <li>
                            ...
                            <div class="btn-group">
                                ...
                                <a type="button" class="share dropdown-toggle"

                                   style="padding: 0;" data-toggle="dropdown"

                                   aria-haspopup="true" aria-expanded="false"

                                   id="share-tip_<?php echo $wishtip->wishtips_id ?>" href="javascript:void(0)"

                                   actType="share_tip" objType="<?php echo 'tip' ?>"

                                   objectId="<?php echo $wishtip->wishtips_id ?>"

                                   obj_parent_id="<?php echo $wishtip->owner_id ?>"

                                   title="Share" data-toggle1="tooltip" data-placement="top">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        ...
                                        <div class="addthis_inline_share_toolbox addthis_toolbox"

                                             data-url="<?php echo base_url("home/tips_detail/" . $wishtip->wishtips_id); ?>"

                                             data-title="<?php echo $wishtip->description ?>"
                ...
                <div class="commet-box">
                    ...
                    <div class="col-md-11 col-sm-10 col-xs-10 comment-area">
                        ...
                        <form id="comment-form_<?php echo $wishtip->wishtips_id ?>" class="form-comment"

                              action="<?php echo base_url('activity/post_comment') ?>" method="POST"

                              actType="comment_tip" objType="tip" objectId="<?php echo $wishtip->wishtips_id ?>"

                              obj_parent_id="<?php echo $wishtip->owner_id ?>">

                            <div class="col-md-12 form-group formmm">

                                <textarea class="form-control" name="comment" id="comment" placeholder="Add Comment"
                            ...
                            <div class="form-group pull-right tt">
                                ...
                                <button type="submit" class="btn btn-default btn-sm hr"> &nbsp; &nbsp; Post Comment &nbsp;
