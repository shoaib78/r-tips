...
<style>
    ...
    .livetips-success.alert.alert-success {border-color: #a3a3a3;color: #7a7a7a;}
    .search_wall .iput3 input {background: #244b5b;    border-radius: 4px !important;}
    .search_wall {border-bottom: 0 !important;}
    .select-styled1:after {border-left: 1px solid #000;color: #127cb4;content: "";font-family: FontAwesome;font-size: 23px;padding: 8px 25px 9px 14px;position: absolute;right: 13px;top: 1px;width: 1px;z-index: 10;}
    .search_wall .input-group.iput3 {width: 100% !important;}
    .search_wall .col-input{width: 100% !important;}
    .search_wall .col-input.btn-div{width: 100% !important;}
    .search_wall .col-input button.search-btn {width: 100%;display: block;background: #127cb4;color: #fff;height: 50px;border: 0;}
        img.rotating-item.img-responsive {position: absolute;}
        .owl-controls {display:none;}
        .owl-carousel .owl-item {width: 30%!important;}
        .owl-carousel .owl-stage {width: 100%!important;}
        .gm-style-iw {height: 130px;}
        #popp-btn{    /*    border-left: 1px solid #ccc;*/}

    <style>.dropzone.dz-started .dz-message {display: block;}
        .dropzone .dz-message,.btn-custom {box-shadow: none;clear: both;color: #38b8e9;display: inline-block;margin: 0;}
        .btn-custom { width:auto; }
        .dz-default.dz-message > span{border: none !important;margin-right: 0px !important;padding: 0px !important;}
        .dropzone {background: white none repeat scroll 0 0;border: none;min-height: auto;width: 100%;padding: 0px;}
        .dropzone .dz-preview .dz-image {border-radius: 3px;height: 100px;width: 100px;}
        .services-left .panel-default .panel-body span{border: none;}
        ...
        #wishtips-form input#tips_title{border: 1px solid #d2d2d2;border-radius: 0;height: 40px;}
        input#wishtips_other_category {border: 1px solid #d2d2d2;border-radius: 0;height: 40px;} 
        #wishtips-form textarea#tips_description {border: 1px solid #d2d2d2;border-radius: 0px;     height: 80px;}
        input#wishtips_location {
            border-radius: 0pc;
        }
        #wishtips-form input#wishtips_other_category
        #wishtips-form input#wishtips_location,  {border: none;border-radius: 0px;height: 40px;border: 1px solid #d2d2d2;    background-color: #fff;}
                                                    ...
                                                    <ul>
                                                        ...
                                                        <?php if (!empty($wishtips_category)) : ?>
                                                            ...
                                                            <?php foreach ($wishtips_category as $k => $cat): ?>
                                                                ...
                                                                <li><a class="wishtips_cat" href="javascript:void(0)"><i class="fa fa-map-pin" aria-hidden="true"></i> <?php echo ucfirst($cat->category_name) ?></a></li>
                    ...
                    <div class="dropdown filter pull-right">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <?php if (!empty($wishtips_category)) : ?>
                                    ...
                                    <li><a class="wishtips_category" href="javascript:void(0);">All Tips</a></li>
                                <?php foreach ($wishtips_category as $k => $cat): ?>
                                    ...
                                    <article>
                                        ...
                                        <div class="artic-tools">
                                            ...
                                            <ul class="list-inline">
                                              ...
                                              <p><a class="report" href="javascript:void(0)" onclick="report('<?php echo $wishtip->wishtips_id ?>');"> Report Abuse</a> &nbsp;<strong style="font-size: 7px;vertical-align: middle;"><i class="fa fa-circle"></i> </strong><a class="report hide_tips" id="tip_<?php echo $wishtip->wishtips_id ?>" href="javascript:void(0)"  actType="hide_tip" objType="<?php echo 'tip' ?>" objectId="<?php echo $wishtip->wishtips_id ?>" obj_parent_id="<?php echo $wishtip->owner_id ?>" title="Hide this tip">Hide</a></p> 
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".wishtips_category").click(function (e) {
            ...
            $(this).closest("ul.dropdown-menu").prev("a.dropdown-toggle").html($(this).text()+' <i class="fa fa-angle-down"></i>');
        ...
        $("#wishtips-form").validate({
            ...
            messages:
            {
                tips_description: "Tips description is required.",
                tips_title:{
                    required: "Tips title is required.",
                },
                wishtips_location:{
                    required: "Tips location is required.",
                },
            },
            submitHandler: function(form) {
                var form = $('#wishtips-form')[0]; // You need to use standart javascript object.
                var formData = new FormData(form);
                formData.append('tips_title',$.trim($("#tips_title").val()));
                formData.append('tips_description', $.trim($("#tips_description").val()));
                formData.append('wishtips_location', $.trim($("#wishtips_location").val()));
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (!data.error) {
                        var msg = '<div class="livetips-success alert alert-success">' + data.message + '</div>';
                        ...
                        $("#popp-btn").html('<i style="color: #2cb2be;" class="fa fa-sort-amount-desc"></i> Category');
                ...
                error: function (jqXHR, textStatus, errorMessage) {
                    var msg = '<div class="alert alert-danger"></p>' + errorMessage + '</div>';
     ...
     $(document).on("submit",".form-comment", function(e){
        ...
        $("comment-comment").mouseout(function() {
          $('.comment-comment').tooltip('hide');
        });
