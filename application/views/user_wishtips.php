<section id="welcome" class="welcome_classic wish">

    <div class="container">

        <div class="classic_inner">

            <h1>My Live Tips Shared</h1>
        ...
        <div class="col-sm-8 posts-wrap ">
            ...
            <ul class="list-unstyled wish-tips wish-list">
                      ...
                      <article>
                                        ...
                                        <div class="articale-header">
                                            ...
                                            <div class="col-md-11 artical-content">
                                             ...
                                             <div class="tip-trash pull-right" role="group">

                                                    <button style="background: transparent;border: 0;" type="button" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a id="" class="delete-tip" title="Delete this Tip" href="javascript:void(0)">Edit</a></li>
                                                    </ul>
                                        ...
                                        <div class="commet-box clearfix">
                                            ...
                                            <div class="col-md-11 comment-area">
                                                ...
                                                <form id="comment-form_<?php echo $wishtip->wishtips_id ?>" class="form-comment" action="<?php echo base_url('activity/post_comment') ?>" method="POST" actType="comment_tip" objType="tip" objectId="<?php echo $wishtip->wishtips_id ?>" obj_parent_id="<?php echo $wishtip->owner_id ?>">
                                                    ...
                                                    <div class="col-md-12 form-group user_wishlist_form">
                ...
                <?php $i++; } ?>
                    ...
                    <?php if($tip_count < $total_count): ?>

                    <div class="show-more">

                        <a data-id="<?php echo $this->session->userdata('user_id'); ?>" data-location="" data-cat="" data-set="" data-bookmark="" data-loading-text="Loading..." class="more btn btn-link btn-block" id="loadmoreTip">Show More...</a>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".comment-comment", function(e) {
            ...
            var objectId = elem.attr('objectId'),

                objType = elem.attr('objType'),

                acttype = elem.attr('acttype'),

                obj_parent_id = elem.attr('obj_parent_id');
        ...
        $(document).on("click", ".delete-tip", function(event) {
            ...
            bootbox.confirm("Do you sure want to delete this tip?", function(result) {

                if (result) {

                    $.post('<?php echo base_url("home/remove_wishtips") ?>', {
    ...
    function like_tip(element) {
        ...
        $.post('<?php echo base_url("activity/likeTip") ?>', {
    ...
    function unlike_tip(element) {
        ...
        $.post('<?php echo base_url("activity/unlikeTip") ?>', {
