 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'userdevloper1-facilitator_api1.gmail.com' : 'PRODUCTION_USERNAME_GOGES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '9PEUZ6EFKMNNF229' : 'PRODUCTION_PASSWORD_GOGES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31A7s93UTLC.DBu1RZQl0rC98Ks2L-' : 'PRODUCTION_SIGNATURE_GOGES_HERE';
...
$config['PayFlowVendor'] = $config['Sandbox'] ? 'tipsandgo' : '';
...
$config['currency'] = 'EUR';
$config['type'] = 'Sale';
$config['return_url'] = BASEURL.'payment/DoExpressCheckout';
$config['cancel_url'] = BASEURL.'payment/OrderCancelled';
$config['ipn_url'] = BASEURL.'payment/ipn';
$config['DeveloperEmailAccount'] = 'developer.shoebuddin@gmail.com';
